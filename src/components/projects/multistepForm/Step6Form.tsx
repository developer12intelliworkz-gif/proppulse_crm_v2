    ...
    >
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Optional — configure third-party portal syndication. You can skip this step.
        </p>
      </div>
        ...
        <CardHeader className="pb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <CardDescription>
                Static fields — live sync will be connected later
              </CardDescription>
            </div>
          </div>
        </CardHeader>
      ...
      <div className="flex gap-3 pt-2">
        <Button
          type="button"
          variant="outline"
          onClick={() => navigate(`${basePath}/step5`)}
          className="flex-1"
        >
          Back
        </Button>
